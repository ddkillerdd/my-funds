...
class Analyzer:
    ...
    def _analyze_4_views(self, qi: QuantIndicators) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                raw = self.llm.call(prompt, temperature=0.3, max_tokens=2048, json_mode=True,
        ...
        try:
            ...
            try:
                raw = self.llm.call(prompt, temperature=0.2, max_tokens=2048, json_mode=True,
    ...
    def _debate_synthesis(
        ...
        try:
            ...
            try:
                raw = self.llm.call(prompt, temperature=0.1, max_tokens=2048, json_mode=True,
    ...
    def _cross_validate(
        ...
        try:
            ...
            raw = self.llm.call(prompt, temperature=0.0, max_tokens=2048, json_mode=True,
